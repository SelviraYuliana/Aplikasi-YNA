...
class PelanggaranForm(forms.Form):
    ...
    alamat = forms.CharField(
        ...
        max_length=200,
        widget=forms.TextInput(
            attrs={'required': True, 'class': 'form-control', 'placeholder': 'Ketikkan Alamat Lengkap Santri'}
        )
    )
    ...
    tindakan = forms.CharField(
        label='Tindakan',
        max_length=200,
        widget=forms.TextInput(
            attrs={'required': True, 'class': 'form-control', 'placeholder': 'Ketikkan Tindakan'}
        )
    )
